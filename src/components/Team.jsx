...
import { MdWorkspacePremium, MdOutlineVerified } from "react-icons/md";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-16">
          ...
          <p className="section-subtitle max-w-2xl mx-auto">
            Led by experienced professionals with decades of combined expertise
            in manufacturing, marketing and technology
          </p>
        </div>
            ...
            >
              ...
              <div className="relative h-56 overflow-hidden bg-slate-100">
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(to bottom, transparent 55%, rgba(15,23,42,0.55))",
                  }}
                />
              </div>
