...
const HERO_FALLBACK = 'https://images.pexels.com/photos/1267338/pexels-photo-1267338.jpeg?auto=compress&cs=tinysrgb&w=1920'
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        />
        <div className="absolute inset-0"
          style={{ background: 'linear-gradient(135deg, rgba(15,23,42,0.94) 0%, rgba(15,23,42,0.78) 55%, rgba(30,41,59,0.88) 100%)' }} />
        {/* Amber accent strip */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 pt-28 pb-20 text-center">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold mb-8"
          style={{ background: 'rgba(217,119,6,0.18)', border: '1px solid rgba(217,119,6,0.45)', color: '#fbbf24' }}>
        ...
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-5 leading-tight"
          style={{ fontFamily: "'Roboto Slab',serif", textShadow: '0 2px 24px rgba(0,0,0,0.5)' }}>
          Champion Magnesite LLP
        </h1>

        <p className="text-xl sm:text-2xl font-semibold mb-4" style={{ color: '#fbbf24' }}>
          Premium Refractory Products Manufacturer
        </p>

        <p className="text-base sm:text-lg max-w-3xl mx-auto mb-10 leading-relaxed" style={{ color: '#94a3b8' }}>
          Delivering high-quality Fire Bricks, High Alumina Bricks, Magnesia Carbon Bricks,
          Castables and specialty refractory solutions for the Iron &amp; Steel industry.
        </p>

        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a href="#products" className="btn-primary text-base px-8 py-3.5">Explore Products</a>
          <a href="#contact" className="btn-outline text-base px-8 py-3.5">Contact Us</a>
        </div>
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-5 max-w-4xl mx-auto">
          {[
            ...
            <div key={s.l} className="rounded-2xl p-5 text-center"
              ...
              <div className="text-3xl font-bold mb-1" style={{ color: '#fbbf24', fontFamily: "'Roboto Slab',serif" }}>{s.v}</div>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1.5 animate-bounce">
        <span className="text-xs font-medium" style={{ color: '#64748b' }}>Scroll Down</span>
